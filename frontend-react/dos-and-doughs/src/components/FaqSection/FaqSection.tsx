...
function FaqSection() {
    return (
        <section id="faq-section">
            ...
            <p style={{textAlign: "center"}}>If you have more questions, don't hesitate to<br /> contact us at <span className="underline"><a href="mailto:info@dosanddoughs.com">info@dosanddoughs.com</a></span></p>
        </section>
    )
}
