  ...
  return (
    <>
      <div className='result-details'>
        <div>
          <a href='mailto:info@dosanddoughs.com' style={{ display: 'block' }}>
            info@dosanddoughs.com
          </a>
        ...
        <div>
          ...
          <p style={{ maxWidth: '300px' }}>
            If something happens to our opening hours, we will post on our social media.
          </p>
        </div>
      </div>
      <div style={{ width: '100%' }}>
          ...
          >
            ...
            >
              <iframe
                ...
                frameBorder='0'
                src='https://www.google.com/maps/embed/v1/place?q=Stora+Gatan,+Västerås,+Sweden&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8'
              ></iframe>
            </div>
            <a
      ...
      <div style={{ position: 'relative' }}>
        ...
        <ul className={`result-list ${isFocused ? 'visible' : ''}`}>
          {filteredLocations.length === 0 ? (
            ...
            [...new Set(filteredLocations.map(location => location.shorthand))].map(
              (shorthand, index) => {
                const location = filteredLocations.find(
                  location => location.shorthand === shorthand,
                )
                return (
